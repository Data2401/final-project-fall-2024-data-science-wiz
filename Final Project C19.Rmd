...
ggplot(q4_africa, aes(x= Country_Region, y = percentage, fill = Country_Region)) + geom_bar(stat= "identity") + scale_y_continuous(labels = percent)

```

### question 4 part Asia
```{r}
q4_Asia <- q4_data %>% filter(Continent_Name == "Asia")

q4_Asia <- q4_Asia %>% filter(Country_Region == "North Korea"  | Country_Region == "South Korea" | Country_Region == "Japan"| Country_Region == "India" | Country_Region == "Iran" | Country_Region == "Russia" | Country_Region == "Singapore" | Country_Region == "Vietnam" | Country_Region == "Lebanon" | Country_Region == "Thailand" ) %>% arrange( Country_Region)
  

ggplot(q4_Asia, aes(x= Country_Region, y = percentage, fill = Country_Region)) + geom_bar(stat= "identity")+ scale_y_continuous(labels = percent)
...
ggplot(q4_europe, aes(x= Country_Region, y = percentage, fill = Country_Region)) + geom_bar(stat= "identity")+ scale_y_continuous(labels = percent)
...
ggplot(q4_NA, aes(x= Country_Region, y = percentage, fill = Country_Region)) + geom_bar(stat= "identity") + scale_y_continuous(labels = percent)
...
ggplot(q4_SA, aes(x= Country_Region, y = percentage, fill = Country_Region)) + geom_bar(stat= "identity") + scale_y_continuous(labels = percent)
