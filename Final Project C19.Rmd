...
#attempts at graphing
#hosp vs death
ggplot(q3_data, aes(x = reorder(Country_Region, -amount), y = amount, fill = type)) + geom_bar(stat = "identity", position = "dodge") + labs(title = "Hospitalized Cases vs Death from Covid-19", x= "Country", y = "")

#top countries with most hosp
ggplot(x, aes(x = reorder(Country_Region, -max), y = max)) + geom_bar(stat = "identity", fill = "lightgreen")+ labs(title = "Top 10 Countries with highest hospitalized rate", x = "Country", y = "")

#top countries with most death
ggplot(y, aes(x = reorder(Country_Region, -max), y = max)) + geom_bar(stat = "identity", fill = "pink") + labs(title = "Top 10 Countries with highest mortality rate", x = "Country", y = "")
```
...
ggplot(most_cases_per_month, aes(x = month, y = sum, color = Continent_Name)) + geom_point(size = 2) + scale_x_log10()



ggplot(most_cases_per_month, aes(x = month, y = sum, color = Continent_Name)) + geom_point(size = 2) + facet_wrap(~ Continent_Name) +scale_x_log10()
