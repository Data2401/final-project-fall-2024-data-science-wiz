...
ggplot(top_5_least_countries, aes(x = Country_Region, y = total_cases, color = Country_Region)) +
  geom_point() +
...
#countries with hospitalized dat 
...
ggplot(x, aes(x = reorder(Country_Region, -max), y = max)) + geom_bar(stat = "identity", fill = "lightgreen")+ labs(title = "Top 10 Countries with highest hospitalized rate", x = "Country", y = "")  + theme(axis.text.x = element_text(angle = 35, hjust = 1))

#top countries with most death
ggplot(y, aes(x = reorder(Country_Region, -max), y = max)) + geom_bar(stat = "identity", fill = "pink") + labs(title = "Top 10 Countries with highest mortality rate", x = "Country", y = "")  + theme(axis.text.x = element_text(angle = 35, hjust = 1))
```
...
ggplot(q4_data, aes(population, percentage, color = Continent_Name)) +geom_point(size = 2, alpha = 1/2) + scale_y_continuous(labels = percent)  + scale_x_log10()  +  theme(axis.text.x = element_text(angle = 35, hjust = 1))

#graph 2 divides it into continents
ggplot(q4_data, aes(population, percentage, color = Continent_Name)) +geom_point(size = 2) + scale_y_continuous(labels = percent) + facet_wrap(~ Continent_Name) + scale_x_log10()  + theme(axis.text.x = element_text(angle = 35, hjust = 1))
...
ggplot(q4_africa, aes(x= reorder(Country_Region,-percentage), y = percentage)) + geom_bar(stat= "identity",show.legend = FALSE, fill = "#F8766D") + scale_y_continuous(labels = percent) +  labs(x = "Country",y = "Cases Percentage")  + theme(axis.text.x = element_text(angle = 35, hjust = 1))
```
...
ggplot(most_cases_per_month, aes(x = month, y = sum, color = Continent_Name)) + geom_point(size = 3) 
