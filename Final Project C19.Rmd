...
# Question 4: 
```{r, message=FALSE}
# Merge COVID-19 data with population 
#Is there any correlation between the country population and covid-19 cases?
...
ggplot(q4_africa, aes(x= Country_Region, y = percentage, fill = Country_Region)) + geom_bar(stat= "identity")
...
ggplot(q4_Asia, aes(x= Country_Region, y = percentage, fill = Country_Region)) + geom_bar(stat= "identity")
...
ggplot(q4_europe, aes(x= Country_Region, y = percentage, fill = Country_Region)) + geom_bar(stat= "identity")
...
ggplot(q4_NA, aes(x= Country_Region, y = percentage, fill = Country_Region)) + geom_bar(stat= "identity")
...
ggplot(q4_SA, aes(x= Country_Region, y = percentage, fill = Country_Region)) + geom_bar(stat= "identity")
