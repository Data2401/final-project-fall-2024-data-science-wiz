...
ggplot(q3_data, aes(x = hospitalizedCurr_max, y = death_max, color = Country_Region)) + geom_point()

ggplot(q3_data, aes(x = death_max)) + geom_histogram(binwidth = 5)
