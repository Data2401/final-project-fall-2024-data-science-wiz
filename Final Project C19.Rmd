...
In this second graph it was much easier to fully visually compare both the amount of deaths and hospitalized cases for each country by providing graphs side by side. There seems to be an issue with Costa Rica as its numbers are not showing up on the graph. 
