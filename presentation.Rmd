...
## R INTRODUCTION
  ...
  The data used was collected from ___ which shows data collected from Covid 19 cases for the first 6 months of 2020 from over 100 countries. We also used data from ___ to collect the population of each country in 2020.
...
## Top 5 Countries with Least Cases on Average
```{r}
...
## Relationship Bewtween Hospitalized Cases and Deaths
```{r}
...
ggplot(q4_africa, aes(x= reorder(Country_Region, -percentage), y = percentage, fill = Country_Region)) + geom_bar(stat= "identity") + scale_y_continuous(labels = percent)
...
ggplot(q4_Asia, aes(x= reorder(Country_Region, -percentage), y = percentage, fill = Country_Region)) + geom_bar(stat= "identity")+ scale_y_continuous(labels = percent)
...
ggplot(q4_europe, aes(x= reorder(Country_Region, -percentage), y = percentage, fill = Country_Region)) + geom_bar(stat= "identity")+ scale_y_continuous(labels = percent)
...
ggplot(q4_NA, aes(x= reorder(Country_Region, -percentage), y = percentage, fill = Country_Region)) + geom_bar(stat= "identity") + scale_y_continuous(labels = percent)
...
ggplot(q4_SA, aes(x= reorder(Country_Region, -percentage), y = percentage, fill = Country_Region)) + geom_bar(stat= "identity") + scale_y_continuous(labels = percent)
