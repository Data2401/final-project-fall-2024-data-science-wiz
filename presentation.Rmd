...
ggplot(q4_data, aes(population, percentage, color = Continent_Name)) +geom_point(size = 2, alpha = 1/2) + scale_y_continuous(labels = percent) + facet_wrap(~ Continent_Name) + scale_x_log10() + labs(title = "Population Percentage affected by Covid-19") + theme(axis.text.x = element_text(angle = 35, hjust = 1))
