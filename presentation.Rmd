...
ggplot(top_5_least_countries, aes(x = Country_Region, y = total_cases, fill = Country_Region)) +
...
ggplot(q4_data, aes(population, percentage, color = Continent_Name)) +geom_point(size = 2, alpha = 1/2) + scale_y_continuous(labels = percent)  + scale_x_log10() + labs(title = "Population Percentage affected by Covid-19")
```

## Correlation between Population and Covid-19 Cases
```{r}
#graph 2 divides it into continents
ggplot(q4_data, aes(population, percentage, color = Continent_Name)) +geom_point(size = 2, alpha = 1/2) + scale_y_continuous(labels = percent) + facet_wrap(~ Continent_Name) + scale_x_log10() + labs(title = "Population Percentage affected by Covid-19")
...
q4_africa <- q4_data %>% filter(Continent_Name == "Africa") %>% arrange(-population) %>% head(10)

ggplot(q4_africa, aes(x= reorder(Country_Region, -percentage), y = percentage)) + geom_bar(stat= "identity",show.legend = FALSE, fill = "#F8766D") + scale_y_continuous(labels = percent) +  labs( title = "Population Percentage affected by Covid-19", x = "Country",y = "Cases Percentage")
...
ggplot(q4_Asia, aes(x= reorder(Country_Region, -percentage), y = percentage, fill = Country_Region)) + geom_bar(stat= "identity",show.legend = FALSE, fill = "#B79F00")+ scale_y_continuous(labels = percent) +  labs( title = "Population Percentage affected by Covid-19",
       x = "Country",
       y = "Cases Percentage")
```
...
ggplot(q4_europe, aes(x= reorder(Country_Region, -percentage), y = percentage, fill = Country_Region)) + geom_bar(stat= "identity",show.legend = FALSE, fill = "#00BA38") + scale_y_continuous(labels = percent) +  labs(title = "Population Percentage affected by Covid-19",
       x = "Country",
       y = "Cases Percentage")
...
ggplot(q4_NA, aes(x= reorder(Country_Region, -percentage), y = percentage, fill = Country_Region)) + geom_bar(stat= "identity",show.legend = FALSE, fill = "#00BFC4") + scale_y_continuous(labels = percent) +  labs(title = "Population Percentage affected by Covid-19",
       x = "Country",
       y = "Cases Percentage")
...
#graph 
ggplot(most_cases_per_month, aes(x = month, y = max, color = Continent_Name)) + geom_point(size = 2, alpha = 1/2) + labs(title = "Peak Covid-19 Cases", x = "Month", y = "Cases")
```

## Peak Covid Cases
```{r}
# separated by continent
ggplot(most_cases_per_month, aes(x = month, y = max, color = Continent_Name)) + geom_point(size = 2) + facet_wrap(~ Continent_Name) + labs(title = "Peak Covid-19 Cases Per Continent", x = "Month", y = "Cases")
```
